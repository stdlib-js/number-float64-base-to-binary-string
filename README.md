...
```javascript
toBinaryString = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float64-base-to-binary-string@v0.0.7-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/number-float64-base-to-binary-string@v0.0.7-umd/browser.js"></script>
```
